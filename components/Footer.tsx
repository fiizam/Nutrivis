      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-space font-bold text-lg text-white">NutriVision AI</span>
          </div>
          <p className="text-neutral-500 text-sm max-w-sm">Advanced Diet & Physical Protocol Optimization System using Greedy Algorithms and CSP.</p>
        </div>
