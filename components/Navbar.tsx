...
export default function Navbar() {
  ...
  return (
    <motion.nav 
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-[#050505]/70 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-6'}`}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex justify-between items-center">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="font-space font-bold text-xl text-white tracking-tight">Nutri<span className="text-[#00FFB2]">Vision</span></span>
        </Link>
